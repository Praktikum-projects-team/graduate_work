...
NOTIFICATIONS_URL = f'{NOTIFICATIONS_SERVICE}/{BASE_URL}/notification'
NOTIFICATIONS_SERVICE_URL = f'{NOTIFICATIONS_URL}/service'
NOTIFICATIONS_ADMIN_URL = f'{NOTIFICATIONS_URL}/admin'
